...
class DocumentBrowserViewController: UIDocumentBrowserViewController, UIDocumentBrowserViewControllerDelegate {
    ...
    func presentDocument(at documentURL: URL) {
        ...
        if let navigationController = documentVC as? UINavigationController, let galleryCollectionViewController = navigationController.visibleViewController as? GalleryCollectionViewController {
